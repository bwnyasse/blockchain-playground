...
/*
Change the contract so that the manager is automatically 
added to the lottery, without sending any ether.
*/
contract Lottery {
    ...
    constructor() {
        ...
        // automatically add manager into the lottery without sending ether
