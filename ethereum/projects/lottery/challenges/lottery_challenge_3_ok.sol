...
Change the contract so that anyone can pick 
the winner and finish the lottery, if there are at least 10 players.
...
contract Lottery{
    ...
    function pickWinner() public{
        // anyone can pick the winner if there are at least 10 players
        //require(msg.sender == manager);
